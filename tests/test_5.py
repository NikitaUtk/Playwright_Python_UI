...
class TestCase:
    ...
    def test2(
        ...
        role_page.navbar.search_modal.correct_filter(dict={'modified_date':str(cur_date), 'clients_shortName': 'ВТБ', 'clients_inn_ogrn_kio':'11', 'clients_bizSize':'Крупный бизнес', 'clients_bizSegment':'Инвестиционные проекты', 'clients_countryName':'RUS', 'clients_kpp':'0', 'checkbox':''})